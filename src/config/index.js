...
export const BLOG_OPENGRAPH_IMAGE_URL =
  "https://localhost:9000/my-bucket/opengraph/blog";
export const SCHOLARSHIP_OPENGRAPH_IMAGE_URL =
  "https://localhost:9000/my-bucket/opengraph/scholarship";
...
export const SCHOLARSHIP_IMAGE_DIR = "scholarships/images/";
export const BLOG_IMAGE_DIR = "blogs/images/";
export const FILE_BASE_URL = "http://localhost:9000/";

export const SITE_NAME = "Hermy Academy";

//! use lower case -> routes?
export const AVAILABLE_DEGREES = ["bachelor", "masters", "phd", "others"];

export const SCHOLARSHIPS_PAGE_SIZE = 6;

export const CURRUNCIES = [
  {
    value: "$",
    label: "Dollar",
  },
